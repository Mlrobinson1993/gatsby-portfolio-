const BlogPosts = {
	GDPR: {
		...
		excerpt:
			'If you don’t comply with GDPR and you operate in, or with a company operating in the European Union, these tips will help you make sure that you’re still producing the same amount of sales, whilst ensuring you’re compliant with GDPR rules.',
...
I can help! For more information on how you can get a your website up to date, including all of the tips you've just seen above, you can contact me here.

Alternatively, you can click here and submit a contact query.I'll get back to you just as soon as I can!

You can also check out some of my previous client work and personal projects here.`,
		slug: 'is-your-website GDPR-compliant-Does-it-need-to-be',
	},
};
